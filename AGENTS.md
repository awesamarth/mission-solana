...
- For heap strings, use `use alloc::string::{String, ToString};`, not `use crate::alloc::...`. Do not enable heap just to log numbers; `solana_program_log::Logger` can append numeric values directly.
